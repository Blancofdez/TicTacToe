package com.blancofdez.tictactoe.ui.core
...
import com.blancofdez.tictactoe.ui.core.Routes.*
...
fun ContentWrapper(navigationController: NavHostController) {
    NavHost(navController = navigationController, startDestination = Home.route)
    {
        composable(Home.route) {
            HomeScree(navigateToGame = { gameId, userId, owner ->
